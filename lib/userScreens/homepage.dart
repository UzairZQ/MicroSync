...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    super.initState();
    // context.read<LocationServices>().requestPermission();
    // context.watch<LocationServices>().listenLocation(currentUser!.uid);
    userLocation();
  }
  ...
  void userLocation() async {
    ...
    await LocationServices().listenLocation(currentUser!.uid);
    Location()
        .changeSettings(interval: 1000, accuracy: LocationAccuracy.balanced);
  ...
  Widget build(BuildContext context) {
    ...
    return Provider<String>(
      create: (context) => currentUser!.uid.toString(),
      child: Scaffold(
